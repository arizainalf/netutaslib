        ...
        <section class="section">
            ...
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <a href="{{ route('book.show', 'pdf') }}" class="btn btn-sm px-3 btn-danger mr-1"
                                target="_blank"><i class="fas fa-file-pdf mr-2"></i>Pdf</a>
                            <a href="{{ route('book.show', 'excel') }}" class="btn btn-sm px-3 btn-info" target="_blank"><i
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            datatableCall('book-table', '{{ route('book.index') }}', [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
                {
            ...
            select2ToJson("#category_id", "{{ route('category.index') }}", "#createModal");
